...
# payload = {"apikey": API_KEY, 'postalCode': '94102'}
...
def find_afterparties():
    ...
    url = 'https://app.ticketmaster.com/discovery/v2/events'
    payload = {'apikey': API_KEY, "keyword": keyword, "postalCode": postalcode, "radius": radius, 
    "unit": unit, "sort": sort}
...
def get_event_details(id):
    ...
    return render_template('event-details.html', data=data, venues=venues)
